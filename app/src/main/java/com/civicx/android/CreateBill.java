...
public class CreateBill extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {

    private RelativeLayout container;
    private final Context mContext = CreateBill.this;
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.dateButton){
            ...
            if (TextUtils.isEmpty(title)) {
                ...
                Post post = new Post(billID,billID,"Bill",title,summary,link,Constants.BILL,getTime(selectedDate),selectedDate,System.currentTimeMillis(),brand,person,brand.getType(), brand.getCountry(),brand.getCategory(),0,0,photos,sections,tags,bookmarks);
